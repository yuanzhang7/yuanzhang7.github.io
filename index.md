...
My research lies at the intersection of **Artificial Intelligence For Medical** -- with a special focus on dealing with the tough task in **Computational Pathology**. My research interests include **Medical Image Analysis**, **Multi-modal learning**, **Federated Learning**, **Vision Language Model**, and **Generation Model**, etc.
